...
func TestMerkleTree(t *testing.T) {
	blocks1 := []block_manager.BufferBlock{
		block_manager.BufferBlock{FileName: "", BlockNumber: 0, Data: []byte{0x01, 0x02, 0x03, 0x02}},
		block_manager.BufferBlock{FileName: "", BlockNumber: 0, Data: []byte{0x01, 0x02, 0x03, 0x02}},
		block_manager.BufferBlock{FileName: "", BlockNumber: 0, Data: []byte{0x01, 0x02, 0x03, 0x02}},
		block_manager.BufferBlock{FileName: "", BlockNumber: 0, Data: []byte{0x01, 0x02, 0x03, 0x02}},
		block_manager.BufferBlock{FileName: "", BlockNumber: 0, Data: []byte{0x01, 0x02, 0x03, 0x02}}}
	blocks2 := []block_manager.BufferBlock{
		block_manager.BufferBlock{FileName: "", BlockNumber: 0, Data: []byte{0x01, 0x02, 0x03, 0x12}},
		block_manager.BufferBlock{FileName: "", BlockNumber: 0, Data: []byte{0x01, 0x02, 0x03, 0x02}},
		block_manager.BufferBlock{FileName: "", BlockNumber: 0, Data: []byte{0x21, 0x02, 0x03, 0x02}},
		block_manager.BufferBlock{FileName: "", BlockNumber: 0, Data: []byte{0x01, 0x02, 0x03, 0x02}},
		block_manager.BufferBlock{FileName: "", BlockNumber: 0, Data: []byte{0x07, 0x02, 0x03, 0x02}}}
